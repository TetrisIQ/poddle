        ...
        <ul class="">
            <li>
                <button on:click={() => change("Account")} class="py-2 flex">
                    ...
                    {/if}
                    <span class="flex ml-1 rounded-r-full pr-2 {selected === 'Account' ? 'bg-gray-200' : ''}">
            ...
            <li class="">
                <button on:click={() => change("MyPolls")} class="py-2 flex">
                    {#if selected === "MyPolls"}
                        <span class="my-auto bg-indigo-400 h-4 w-1"></span>
                    {/if}
                    <span class="flex ml-1 rounded-r-full pr-2 {selected === 'MyPolls' ? 'bg-gray-200' : ''}">
            ...
            <li class="">
                <button on:click={() => change("Settings")} class="py-2 flex">
                    {#if selected === "Settings"}
                        <span class="my-auto bg-indigo-400 h-4 w-1"></span>
                    {/if}
                    <span class="flex ml-1 rounded-r-full pr-2 {selected === 'Settings' ? 'bg-gray-200' : ''}">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="mx-2 my-auto"
                     viewBox="0 0 16 16">
