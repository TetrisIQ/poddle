        ...
        <div class="flex-wrap text-left">
            <div class="grid justify-end grid-cols-3 gap-4 py-4">
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor"
                     class="ml-auto mr-5 my-auto" viewBox="0 0 16 16">
                    <path d="M2.5 8a5.5 5.5 0 0 1 8.25-4.764.5.5 0 0 0 .5-.866A6.5 6.5 0 1 0 14.5 8a.5.5 0 0 0-1 0 5.5 5.5 0 1 1-11 0z"/>
                    <path d="M15.354 3.354a.5.5 0 0 0-.708-.708L8 9.293 5.354 6.646a.5.5 0 1 0-.708.708l3 3a.5.5 0 0 0 .708 0l7-7z"/>
                </svg>
                <div>
                    <h2 class="font-bold">Yes, no, if need be</h2>
                    <p>Participants can indicate if an option is not ideal for them.</p>
                </div>
                <Checkbox bind:checked={settings.treeOptions}
            ...
            <div class="grid justify-end grid-cols-3 gap-4 py-4">
                ...
                <div>
                    ...
                    {#if settings.voteLimit}
                        <input bind:value={settings.voteLimitAmount} type="number" min="1"
                ...
                <Checkbox disabled={settings.treeOptions} bind:checked={settings.voteLimit}
                          primaryColor="#f7be00" class="my-auto ml-5"/>
            </div>
            <div class="grid justify-end grid-cols-3 gap-4 py-4">
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor"
                ...
                <Checkbox bind:checked={settings.deadline}
                          primaryColor="#f7be00" class="my-auto ml-5"/>
            </div>
        </div>
    </div>
