<script lang="ts">
    ...
    function next() {
        page.set(CreatePoll2)
    }

</script>

{#if currentPoll !== undefined}
    <form on:submit|preventDefault={() => next()} class="mx-auto max-w-4xl rounded overflow-hidden shadow-lg">
        ...
        <div class="px-6 py-4">
            ...
            <div class="flex flex-wrap gap-3 w-full p-5">
                <label class="relative w-full flex flex-col">
                    ...
                    <input bind:value={$currentPoll.title}
                           class="rounded-md peer pl-12 pr-2 py-2 border-2 border-gray-200 placeholder-gray-300"
                           type="text" name="title" placeholder="Enter title" required/>
            ...
            <div class="flex flex-wrap gap-3 w-full p-5">
                <label class="relative w-full flex flex-col">
                    ...
                    <input bind:value={$currentPoll.location}
                           class="rounded-md peer pl-12 pr-2 py-2 border-2 border-gray-200 placeholder-gray-300"
                           type="text" name="Add location" placeholder="Enter title"/>
            ...
            <div class="flex flex-wrap gap-3 w-full p-5">
                <label class="relative w-full flex flex-col">
                    ...
                    <input bind:value={$currentPoll.note}
                           class="rounded-md peer pl-12 pr-2 py-2 border-2 border-gray-200 placeholder-gray-300"
