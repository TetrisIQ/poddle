                    ...
                    <div on:click={() => openPoll(poll)}
                        ...
                        <div class="background overlay my-auto flex dark:text-white">
                            ...
                            <div class="py-2 my-auto px-4 ml-auto">
                                {poll.percent === undefined ? '' : poll.percent + ' |'}  {poll.participants}
                                Participants
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-span-12 sm:col-span-6 md:col-span-3 mx-auto">
                    <div class="flex flex-row bg-white shadow-sm rounded p-4">
                        <div class="flex items-center justify-center flex-shrink-0 h-12 w-12 rounded-xl bg-blue-100 text-blue-500">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-balloon-heart" viewBox="0 0 16 16">
                        ...
                        <div class="flex flex-col flex-grow ml-4">
                            ...
                            <div class="text-sm text-gray-500">Create a poll or participate to a poll to see a list here.</div>
                        </div>
                    </div>
                </div>
            </div>
