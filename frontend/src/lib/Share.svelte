<script lang="ts">
    ...
    function shareWhatsApp() { // Works only on mobile
...
<div class="flex items-center justify-center">
    <!--MODAL ITEM-->
    <div class="bg-gray-100 w-full my-4 p-4 rounded-xl md:w-1/2 lg:w-1/3">
        ...
        <div class="my-4">
            ...
            <div class="flex justify-around my-4">
                <!--FACEBOOK ICON-->
                {#if facebook}
                    <div on:click={() => shareFacebook()} class="border hover:bg-[#1877f2] w-12 h-12 fill-[#1877f2] hover:fill-white border-blue-200 rounded-full flex items-center justify-center shadow-xl hover:shadow-blue-500/50 cursor-pointer">
                        <svg
                ...
                <!--WHATSAPP ICON-->
                {#if whatsapp}
                    <div title="works only on mobile" on:click={() => shareWhatsApp()} class="border hover:bg-[#25D366] w-12 h-12 fill-[#25D366] hover:fill-white border-green-200 rounded-full flex items-center justify-center shadow-xl hover:shadow-green-500/50 cursor-pointer">
                        <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="24"
                                height="24"
                ...
                <!--TELEGRAM ICON-->
                {#if telegram}
                    <div on:click={() => shareTelegram()} class="border hover:bg-[#229ED9] w-12 h-12 fill-[#229ED9] hover:fill-white border-sky-200 rounded-full flex items-center justify-center shadow-xl hover:shadow-sky-500/50 cursor-pointer">
                        <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="24"
                                height="24"
                ...
                <!--TELEGRAM ICON-->
                {#if email}
                    <div on:click={() => openMailTo()} class="border hover:bg-red-400 w-12 h-12 fill-red-400 hover:fill-white border-red-200 rounded-full flex items-center justify-center shadow-xl hover:shadow-sky-500/50 cursor-pointer">
                        <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="24"
                                height="24"
            ...
            <div class="border-2 border-gray-200 w-full flex justify-between items-center mt-4 py-2">
                <svg
                    ...
                    <path
                            d="m12 4.929-.707.707 1.414 1.414.707-.707a3.007 3.007 0 0 1 4.243 0 3.005 3.005 0 0 1 0 4.243l-2.122 2.121c-1.133 1.133-3.109 1.133-4.242 0L10.586 12l-1.414 1.414.707.707c.943.944 2.199 1.465 3.535 1.465s2.592-.521 3.535-1.465L19.071 12a5.008 5.008 0 0 0 0-7.071 5.006 5.006 0 0 0-7.071 0z"></path>
                </svg>
