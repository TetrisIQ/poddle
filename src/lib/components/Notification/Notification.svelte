		...
		<div class="flex items-center">
			...
			{:else}
				<svg
					...
					height="16"
					fill="currentColor"
					class="w-16 h-16 rounded-2xl p-3 border border-blue-100 text-red-500 bg-blue-50"
					viewBox="0 0 16 16"
				>
			...
			<div class="flex flex-col ml-3">
				<div class="font-medium leading-none">{title}</div>
				<p class="text-sm text-gray-600 leading-none mt-1">{subtitle}</p>
			</div>
		</div>
	</div>
</div>
