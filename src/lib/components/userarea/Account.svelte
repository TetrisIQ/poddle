		...
		<div class="w-full max-w-md">
			...
			<div class="flex">
				...
				<button
					...
					class="text-red-600 ml-auto inline-flex items-center  bg-gray-100 border-0 py-1 px-3 focus:outline-none  hover:bg-gray-200 rounded text-base mt-4 md:mt-0"
				>
					<svg
		...
		<div class="w-full max-w-md">
			<div class="">
				<ul class="">
					...
					<li class="p-2">
						You don't need an Email address for your account so you cannot reset your password if
						you lose it. There is no way you can restore it.
					</li>
