<script lang="ts">
    ...
    function addNewParticipant() {
        $currentPoll.participants.push(new Participant("", true, $currentPoll.options));
        $currentPoll = $currentPoll;
    }
    ...
    function addComment() {
        $currentPoll.comments.push(new Comment(lstore.getMyName(), newComment, new Date()))
        newComment = "";
        $currentPoll = $currentPoll;
        update();
    }
            ...
            <table class="border-collapse border mx-auto mt-8 border-slate-400">
                ...
                <tr>
                    <td class="border border-slate-300 py-2 px-5">
                        ...
                        <span class="col-start-1 col-end-6 text-left">{$currentPoll.participants.length}
                            participants</span>
                            ...
                            <div class="grid grid-cols-6 gap-4">
                                ...
                                {#if deadlineIsNotReached()}
                                    {#if lstore.getMyName() === participant.name || participant.edit}
                                        <div on:click={() => updateEdit(participant)}
